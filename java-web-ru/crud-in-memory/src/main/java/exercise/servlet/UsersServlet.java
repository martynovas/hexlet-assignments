...
public class UsersServlet extends HttpServlet {
    ...
    private void updateUser(HttpServletRequest request,
        ...
        inputUser.put("id",id);
        inputUser.put("firstName", request.getParameter("firstName"));
        inputUser.put("lastName", request.getParameter("lastName"));
        inputUser.put("email", request.getParameter("email"));
        if (inputUser.get("firstName").isEmpty() || inputUser.get("lastName").isEmpty()) {
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("/edit.jsp");
        ...
        user.put("firstName",inputUser.get("firstName"));
        user.put("lastName",inputUser.get("lastName"));
        user.put("email",inputUser.get("email"));
